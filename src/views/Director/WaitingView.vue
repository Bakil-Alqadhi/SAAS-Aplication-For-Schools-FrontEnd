...
<div v-if="showCards" class="flex flex-wrap cards  justify-center  p-8 items-center mt-8">
...
<div v-if="showTeachers" class="flex container flex-col text-3xl m-10 rounded-lg">
        ...
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-blue-400">
              <tr>
                <th scope="col" class="px-6 py-3 text-center  font-medium text-white uppercase tracking-wider">
                  ID
                </th>
                <th scope="col" class="px-6 py-3 text-center  font-medium text-white uppercase tracking-wider">
                  Image
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr  v-for="(teacher, index) in teachers" :key="index">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-2xl font-medium text-gray-900">
                  <img :src="teacher.image" alt="Student Image" class="h-8 w-8 rounded-full">
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-2xl font-medium text-gray-900">
            ...
            <table class="min-w-max w-full table-auto">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    <tr v-for="(teacher, index) in teachers" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-center text-black whitespace-nowrap">
                            {{ index+1 }}
                        </td>
