...
const store = ()=>{
    console.log('=============')
        ...
        console.log('=============') 
    storeDataSchools.dispatch('handleCreateExam', form.value)
}
</script>
...
<div class="container"> 
    <form class="main-form" @submit.prevent="store">
        ...
        <div class="parent" >
            ...
            <input class="field" v-model="form.term" type="number" min="1" max="2" id="section_name"  placeholder="Section Name" />
            <span v-if="errors.term">{{ errors.term[0] }}</span>
        </div>
        <div class="parent" >
            <label for="section_name">Academic Year:</label>
            <select class="field" v-model="form.academic_year" id="academic_year_new">
