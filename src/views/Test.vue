  ...
  <div class="w-screen h-screen flex">
      ...
      <div class="w-[400px] h-full bg-gray-200 text-white" v-show="showSide">
          <div class="h-[50px] bg-gray-900 flex justify-start  items-center ">
              <div class="px-[20px]">
                  <img src="https://tecdn.b-cdn.net/img/Photos/Avatars/img%20(23).webp" alt="Avatar" class="mb-4 h-auto rounded-full align-middle" style="max-width: 50px;" />
                  <h4 class=" text-2xl font-medium leading-[1.2]">Ann Smith</h4>
