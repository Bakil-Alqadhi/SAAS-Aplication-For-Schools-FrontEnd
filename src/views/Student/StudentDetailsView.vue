...
watch(authUser, newValue =>{
  storeDataStudents.dispatch('fetchOneStudent', { school:newValue.school_id, student: props.id })
})
    ...
    <table class="w-full border-collapse border border-gray-200">
      <tbody>
        ...
        <tr>
          ...
          <td class="p-4 border border-gray-200"><img :src="student.image_path" class="h-24 rounded-full object-cover" alt="Student Photo"></td>
        </tr>
        <tr>
