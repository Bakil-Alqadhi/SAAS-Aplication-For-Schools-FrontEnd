...
<div class="m-auto p-10 space-y-8">
    <h1 class="font-bold text-lg text-center rounded-lg bg-slate-400 shadow-md text-white p-3">Registration New School</h1>
    <form @submit.prevent="register" class=" rounded-lg w-full bg-slate-400  p-5 grid gap-x-10 mb-6 md:grid-cols-2">
